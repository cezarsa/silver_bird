  ...
  $.createContextMenuItems = function(menuData) {
    ...
    for(var i = 0, len = menuData.length; i < len; ++i) {
      if(menuData[i].label == 'separator') {
        retHtml += '<li class="separator"></li>';
      } else {
        var className = menuData[i].className || '';
        if(className) {
          className = ' class = "' + className + '"';
        }
        retHtml += '<li' + className + '><a href="#' + menuData[i].action + '">' + menuData[i].label + '</a></li>';
      }
    }
    return retHtml;
  };
          ...
          $(this).mouseup( function(e) {
            ...
            if( evt.button == 2 || evt.ctrlKey ) {
              ...
              if(o.onBeforeShow) {
                ...
                var newMenuHtml = $.createContextMenuItems(menuData);
